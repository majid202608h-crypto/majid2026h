            ...
            Column(
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            Text("بازیکن اول", fontSize = 12.sp, color = Color(0xFF93C5FD), fontWeight = FontWeight.Bold)
                            Spacer(Modifier.height(4.dp))
                            OutlinedTextField(
                                value = name1,
                                onValueChange = { if (it.length <= 18) { name1 = it; viewModel.updateDuelPrefs(player1Name = it) } },
                                placeholder = { Text("نام...", color = Color(0xFF93C5FD).copy(alpha=0.5f), fontSize = 14.sp) },
                ...
                Card(
                    ...
                    Row(
                        ...
                        Spacer(Modifier.width(16.dp))
                        Column(modifier = Modifier.weight(1f)) {
                            Text("بازیکن دوم", fontSize = 12.sp, color = Color(0xFF6EE7B7), fontWeight = FontWeight.Bold)
                            Spacer(Modifier.height(4.dp))
                            OutlinedTextField(
                                value = name2,
                                onValueChange = { if (it.length <= 18) { name2 = it; viewModel.updateDuelPrefs(player2Name = it) } },
                                placeholder = { Text("نام...", color = Color(0xFF6EE7B7).copy(alpha=0.5f), fontSize = 14.sp) },
                                modifier = Modifier.fillMaxWidth().height(56.dp),
                                singleLine = true,
                                shape = RoundedCornerShape(12.dp),
                                colors = androidx.compose.material3.OutlinedTextFieldDefaults.colors(
                ...
                Card(
                    ...
                    Column(Modifier.padding(16.dp), horizontalAlignment = Alignment.CenterHorizontally) {
                        Text("⏱ زمان مسابقه", fontSize = 14.sp, color = Color.White, fontWeight = FontWeight.Bold)
                ...
                Box(
                    modifier = Modifier
                        ...
                        .shadow(if (isPressed) 4.dp else 16.dp, RoundedCornerShape(28.dp), spotColor = Color(0xFF8B5CF6))
                        .background(
                    ...
                    Text("🚀 شروع مسابقه", color = Color.White, fontSize = 18.sp, fontWeight = FontWeight.Black)
                }
                ...
                OutlinedButton(
                    ...
                    Text("بازگشت به منو", color = Color(0xFFA5B4FC), fontSize = 16.sp, fontWeight = FontWeight.Bold)
                }
...
if match:
    ...
    with open('app/src/main/java/com/example/MainActivity.kt', 'w') as f:
        f.write(new_content)
    print("Patched DuelSetupScreen layout successfully")
else:
